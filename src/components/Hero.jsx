      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20 relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-500/10 border border-brand-400/20 text-brand-300 text-xs font-semibold uppercase tracking-wider">
              <Warehouse className="w-3.5 h-3.5 text-brand-400" />
              <span>Direct Importers • Surat Godown Ready Stock</span>
            </div>
            ...
            <p className="text-slate-300 text-base sm:text-lg max-w-2xl font-normal leading-relaxed">
              Wholesale trade supply for FMCG packers, dairy brands, hotels, cafes, gift retailers, and e-commerce sellers. Select your cartons and receive proforma quotes directly on WhatsApp.
            </p>
            ...
            <div className="grid grid-cols-3 gap-3 pt-4 border-t border-slate-800/80">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">From 1 Box to Full Truck</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Direct Ex-Godown Rates</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Transporter Dispatch</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-3.5">
            <div className="space-y-3.5">
              <div 
                onClick={() => setSelectedCategory('jars')}
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent flex items-end p-3">
                  <div>
                    <span className="text-[11px] font-semibold text-brand-300">Popular</span>
                    <p className="text-sm font-bold text-white leading-tight">Food Storage Jars</p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent flex items-end p-3">
                  <div>
                    <span className="text-[11px] font-semibold text-emerald-300">Commercial</span>
                    <p className="text-sm font-bold text-white leading-tight">Milk & Beverage Bottles</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3.5 pt-4">
              <div 
                onClick={() => setSelectedCategory('decanters')}
                className="group relative rounded-2xl overflow-hidden border border-slate-700/60 bg-slate-800 shadow-xl cursor-pointer hover:border-brand-500/50 transition-all"
              >
                <img 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent flex items-end p-3">
                  <div>
                    <span className="text-[11px] font-semibold text-amber-300">Luxury Barware</span>
                    <p className="text-sm font-bold text-white leading-tight">AK47 & Plane Decanters</p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent flex items-end p-3">
                  <div>
                    <span className="text-[11px] font-semibold text-sky-300">Embossed</span>
                    <p className="text-sm font-bold text-white leading-tight">Tiger Whisky Glasses</p>
                  </div>
                </div>
              </div>
            </div>
